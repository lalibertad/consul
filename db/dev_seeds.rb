...
section "Creating Geozones" do
  ...
  Geozone.create(name: "Víctor Larco", geozone_id: geo)
  Geozone.create(name: "El Porvenir", geozone_id: geo)
  Geozone.create(name: "La Esperanza", geozone_id: geo)
  Geozone.create(name: "Huanchaco", geozone_id: geo)
  Geozone.create(name: "Florencia de Mora", geozone_id: geo)
  Geozone.create(name: "Laredo", geozone_id: geo)
  Geozone.create(name: "Moche", geozone_id: geo)
  Geozone.create(name: "Salaverry", geozone_id: geo)
  Geozone.create(name: "Simbal", geozone_id: geo)
  Geozone.create(name: "Poroto", geozone_id: geo)
  Geozone.create(name: "Trujillo", geozone_id: geo)
  ...
  Geozone.create(name: "Santa Cruz de Chuca", geozone_id: geo)
  Geozone.create(name: "Quiruvilca", geozone_id: geo)
  Geozone.create(name: "Cachicadán", geozone_id: geo)
  Geozone.create(name: "Angasmarca", geozone_id: geo)
  Geozone.create(name: "Sitabamba", geozone_id: geo)
  Geozone.create(name: "Mollepata", geozone_id: geo)
  Geozone.create(name: "Mollebamba", geozone_id: geo)
  Geozone.create(name: "Santiago de Chuco", geozone_id: geo)
  ...
  Geozone.create(name: "Chao", geozone_id: geo)
  Geozone.create(name: "Guadalupito", geozone_id: geo)
  Geozone.create(name: "Virú", geozone_id: geo)
  ...
  Geozone.create(name: "Huamachuco", geozone_id: geo)
  Geozone.create(name: "Chugay", geozone_id: geo)
  Geozone.create(name: "Marcabal", geozone_id: geo)
  Geozone.create(name: "Sanagorán", geozone_id: geo)
  Geozone.create(name: "Sartimbamba", geozone_id: geo)
  Geozone.create(name: "Sarín", geozone_id: geo)
  Geozone.create(name: "Cochorco", geozone_id: geo)
  Geozone.create(name: "Curgos", geozone_id: geo)
  ...
  Geozone.create(name: "Parcoy", geozone_id: geo)
  Geozone.create(name: "Tayabamba", geozone_id: geo)
  Geozone.create(name: "Chilia", geozone_id: geo)
  Geozone.create(name: "Pataz", geozone_id: geo)
  Geozone.create(name: "Huancaspata", geozone_id: geo)
  Geozone.create(name: "Huayo", geozone_id: geo)
  Geozone.create(name: "Buldibuyo", geozone_id: geo)
  Geozone.create(name: "Urpay", geozone_id: geo)
  Geozone.create(name: "Taurija", geozone_id: geo)
  Geozone.create(name: "Santiago de Challas", geozone_id: geo)
  Geozone.create(name: "Huaylillas", geozone_id: geo)
  Geozone.create(name: "Ongón", geozone_id: geo)
  Geozone.create(name: "Pías", geozone_id: geo)
  ...
  Geozone.create(name: "Guadalupe", geozone_id: geo)
  Geozone.create(name: "Pacasmayo", geozone_id: geo)
  Geozone.create(name: "San Pedro de Lloc", geozone_id: geo)
  Geozone.create(name: "San José", geozone_id: geo)
  Geozone.create(name: "Jequetepeque", geozone_id: geo)
  ...
  Geozone.create(name: "Usquil", geozone_id: geo)
  Geozone.create(name: "Otuzco", geozone_id: geo)
  Geozone.create(name: "Agallpampa", geozone_id: geo)
  Geozone.create(name: "Sinsicap", geozone_id: geo)
  Geozone.create(name: "Salpo", geozone_id: geo)
  Geozone.create(name: "Huaranchal", geozone_id: geo)
  Geozone.create(name: "Mache", geozone_id: geo)
  Geozone.create(name: "Charat", geozone_id: geo)
  Geozone.create(name: "La Cuesta", geozone_id: geo)
  Geozone.create(name: "Paranday", geozone_id: geo)
  ...
  Geozone.create(name: "Julcán", geozone_id: geo)
  Geozone.create(name: "Carabamba", geozone_id: geo)
  Geozone.create(name: "Calamarca", geozone_id: geo)
  Geozone.create(name: "Huaso", geozone_id: geo)
  ...
  Geozone.create(name: "Cascas", geozone_id: geo)
  Geozone.create(name: "Marmot", geozone_id: geo)
  Geozone.create(name: "Sayapullo", geozone_id: geo)
  Geozone.create(name: "Lucma", geozone_id: geo)
  ...
  Geozone.create(name: "Chepén", geozone_id: geo)
  Geozone.create(name: "Pacanga", geozone_id: geo)
  Geozone.create(name: "Pueblo Nuevo", geozone_id: geo)
  ...
  Geozone.create(name: "Bolívar", geozone_id: geo)
  Geozone.create(name: "Bambamarca", geozone_id: geo)
  Geozone.create(name: "Uchumarca", geozone_id: geo)
  Geozone.create(name: "Longotea", geozone_id: geo)
  Geozone.create(name: "Condormarca", geozone_id: geo)
  Geozone.create(name: "Ucuncha", geozone_id: geo)
  ...
  Geozone.create(name: "Casa Grande", geozone_id: geo)
  Geozone.create(name: "Paiján", geozone_id: geo)
  Geozone.create(name: "Santiago de Cao", geozone_id: geo)
  Geozone.create(name: "Chicama", geozone_id: geo)
  Geozone.create(name: "Chocope", geozone_id: geo)
  Geozone.create(name: "Rázuri", geozone_id: geo)
  Geozone.create(name: "Ascope", geozone_id: geo)
  Geozone.create(name: "Magdalena de Cao", geozone_id: geo)
