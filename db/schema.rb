...
ActiveRecord::Schema.define(version: 20171030193706) do
  ...
  create_table "locks", force: :cascade do |t|
    ...
    t.datetime "locked_until", default: '2000-01-01 06:01:01', null: false
    t.datetime "created_at",                                   null: false
    t.datetime "updated_at",                                   null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "password_changed_at",                       default: '2015-01-01 06:01:01', null: false
